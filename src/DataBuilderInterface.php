...
use Mothership\Payload\Data;
use Stringable;
use Throwable;

/**
 * A data builder is used to normalize, parse, and prepare errors, exceptions, and messages to Mothership.
 */
interface DataBuilderInterface
{
    ...
    /**
     * Adds a new key / value pair that will be sent with the payload to Mothership.
     *
