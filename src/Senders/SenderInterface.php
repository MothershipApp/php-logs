...
/**
 * The sender interface is used to define how an error report sender should transport payloads to Mothership Service.
 *
...
{
    /**
     * Sends the payload to the Mothership service and returns the response.
     *
     * @param EncodedPayload $payload     The payload to deliver to the Mothership service.
    ...
    /**
     * Sends an array of payloads to the Mothership service.
     *
