...
{
    /**
     * The instance of the logger. This is null if Mothership has not been initialized or {@see Mothership::destroy()} has
     * been called.
     *
     * @var MothershipLogger|null
     */
    private static ?MothershipLogger $logger = null;

    /**
     * The fatal error handler instance or null if it was disabled or Mothership has not been initialized.
     *
    ...
    /**
     * The error handler instance or null if it was disabled or Mothership has not been initialized.
     *
    ...
    /**
     * The exception handler instance or null if it was disabled or Mothership has not been initialized.
     *
    ...
    /**
     * Sets up Mothership monitoring and logging.
     *
     ...
     * {@see Mothership::destroy()} first.
     *
     * Example:
     *
     *     // Turn off the fatal error handler
     *     $configs = Mothership::logger()->getConfig();
     *     Mothership::destroy();
     *     Mothership::init($configs, handleFatal: false);
     *
     * @param MothershipLogger|array $configOrLogger  This can be either an array of config options or an already
     *                                             configured {@see MothershipLogger} instance.
     * @param bool                $handleException If set to false Mothership will not monitor exceptions.
     * @param bool                $handleError     If set to false Mothership will not monitor errors.
     * @param bool                $handleFatal     If set to false Mothership will not monitor fatal errors.
     *
     * @return void
     * @throws Exception If the $configOrLogger argument is an array that has invalid configs.
     *
     * @link https://docs.mothership.app
     */
    public static function init(
        MothershipLogger|array $configOrLogger,
    ...
    /**
     * Creates or configures the MothershipLogger instance.
     *
     * @param MothershipLogger|array $configOrLogger The configs array or a new {@see MothershipLogger} to use or replace the
     ...
     * @throws Exception If the $configOrLogger argument is an array that has invalid configs.
     */
    private static function setLogger(MothershipLogger|array $configOrLogger): void
    {
        if ($configOrLogger instanceof MothershipLogger) {
        ...
        self::$logger = new MothershipLogger($configOrLogger);
    }

    /**
     * Enables logging of errors to Mothership.
     *
     * @return void
     */
    ...
    /**
     * Disables logging of errors to Mothership.
     *
     * @return void
     */
    ...
    /**
     * Returns true if the Mothership logger is enabled.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if the Mothership logger is disabled.
     *
     * @return bool
     */
     ...
     *
     * @return MothershipLogger|null
     */
    public static function logger(): ?MothershipLogger
    {
        return self::$logger;
    }

    /**
     * Creates and returns a new {@see MothershipLogger} instance.
     *
     * @param array $config The configs extend the configs of the current logger instance, if it exists.
     *
     * @return MothershipLogger
     * @throws Exception If the $config argument is an array that has invalid configs.
     */
    public static function scope(array $config): MothershipLogger
    {
        if (is_null(self::$logger)) {
            return new MothershipLogger($config);
        }
        return self::$logger->scope($config);
    }

    /**
     * Logs a message to the Mothership service with the specified level.
     *
    ...
    /**
     * Creates the {@see Response} object and reports the message to the Mothership
     * service.
     *
     * @param string|Level      $level   The severity level to send to Mothership.
     * @param string|Stringable $message The log message.
    ...
    /**
     * Creates and returns a {@see Response} to use if Mothership is attempted to be used prior to being initialized.
     *
     * @return Response
     */
    private static function getNotInitializedResponse(): Response
    {
        return new Response(0, "Mothership Not Initialized");
    }

    /**
     * This method makes sure the queue of logs stored in memory are sent to Mothership prior to shut down.
     *
     * @return void
     */
    public static function setupBatchHandling(): void
    {
        register_shutdown_function('Mothership\Mothership::flushAndWait');
    }

    /**
     * Sends all the queued logs to Mothership.
     *
     * @return void
     */
    ...
    /**
     * Sends all the queued logs to Mothership and waits for the response.
     *
     * @return void
     */
    ...
    /**
     * Configures the existing {@see MothershipLogger} instance.
     *
